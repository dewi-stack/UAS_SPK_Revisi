    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home">
                ...
                <div class="sidebar-brand-text mx-5">SPK</div>
            </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="button font-weight-bold text-primary text-uppercase mb-1">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="button font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{ route('kriteria.index') }}"> Kriteria & Pembobotan </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="button font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{ route('cafe.index') }}"> Metode Perhitungan </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
