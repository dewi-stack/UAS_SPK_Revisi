                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form action="{{ route('cafe.importData') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="card-body">
                        <form method="post" action="{{ route('cafe.store') }}" id="myForm">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="kualitas" name="kualitas" class="form-control" id="kualitas" ariadescribedby="kualitas">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="pelayanan" name="pelayanan" class="form-control" id="pelayanan" ariadescribedby="pelayanan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="lokasi" name="lokasi" class="form-control" id="lokasi" ariadescribedby="lokasi">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="wifi" name="wifi" class="form-control" id="wifi" ariadescribedby="wifi">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="suasana" name="suasana" class="form-control" id="suasana" ariadescribedby="suasana">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="kenyamanan" name="kenyamanan" class="form-control" id="kenyamanan" ariadescribedby="kenyamanan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="kebersihan" name="kebersihan" class="form-control" id="kebersihan" ariadescribedby="kebersihan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="menu_unik" name="menu_unik" class="form-control" id="menu_unik" ariadescribedby="menu_unik">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="respon" name="respon" class="form-control" id="respon" ariadescribedby="respon">
                                    </div>
                                </div>
