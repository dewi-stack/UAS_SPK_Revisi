        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Ini merupakan data dari Solusi Ideal Negatif.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">DataTables Solusi Ideal Negatif</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">

                            <h1>Negative Ideal Solution</h1>

                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Kriteria</th>
                                    <th>Negative Ideal Solution</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($negativeIdealSolution as $key => $value)
                                    <tr>
                                        <td>{{ $key }}</td>
                                        <td>{{ $value }}</td>
                                    </tr>
